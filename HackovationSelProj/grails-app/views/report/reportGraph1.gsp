...
<head>
	...
	<meta charset="UTF-8">
	<link rel="stylesheet" href="http://localhost:8080/HackovationSelProj/static/css/bootstrap.min.css">
	<script src="http://localhost:8080/HackovationSelProj/static/js/jquery.js"></script>
  <script src="http://localhost:8080/HackovationSelProj/static/js/highcharts.js"></script>
	<script>
     $(function() {
        var backgroundColor;
        $('#btn').click(function(){
